...
public class RequestController {
	...
	public ResponseEntity<String> getAll()
	{
		 ...
		 double total = 0;
		    ...
		    System.out.println(requestId + "" + requestCustomerEmail + "" + requestCustomerEmail + "" + total); 
		    return ResponseEntity.status(HttpStatus.OK)
		            .body("" + requestId + "" + requestCustomerEmail + "" + requestCustomerName + "" +  requestCustomerEmail + "" + total);
	}
}
